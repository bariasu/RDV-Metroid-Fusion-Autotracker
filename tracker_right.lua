    ...
    if CURRENT_FRAME % CHECK_INTERVAL == 0 and memory.read_u16_le(GAMEMODE_ADDRESS) == 1 then
        ...
        if CHECK_LOADOUT then
            ...
            if SECURITY_VALUE & BLUE_VALUE == BLUE_VALUE then
                gui.drawImage(IMAGES.l1, 249, 122, nil, nil, false)
            else
                gui.drawImage(IMAGES.l1_gray, 249, 122, nil, nil, false)
            end

            if SECURITY_VALUE & GREEN_VALUE == GREEN_VALUE then
                gui.drawImage(IMAGES.l2, 266, 122, nil, nil, false)
            else
                gui.drawImage(IMAGES.l2_gray, 266, 122, nil, nil, false)
            end

            if SECURITY_VALUE & YELLOW_VALUE == YELLOW_VALUE then
                gui.drawImage(IMAGES.l3, 283, 122, nil, nil, false)
            else
                gui.drawImage(IMAGES.l3_gray, 283, 122, nil, nil, false)
            end

            if SECURITY_VALUE & RED_VALUE == RED_VALUE then
                gui.drawImage(IMAGES.l4, 300, 122, nil, nil, false)
            else
                gui.drawImage(IMAGES.l4_gray, 300, 122, nil, nil, false)
            end
